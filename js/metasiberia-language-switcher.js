(function() {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      "#rec858665447 .t134__descr{margin:0 auto;color:#f4efe5 !important;text-align:center;font:600 clamp(30px,4.3vw,58px)/1.02 'Source Code Pro',monospace;letter-spacing:0;text-transform:none;text-wrap:balance;}",
