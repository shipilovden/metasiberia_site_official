...
t_onReady(function(){t300_init();if('MutationObserver' in window){setTimeout(function(){var stores=document.querySelectorAll('body .t-store');Array.prototype.forEach.call(stores,function(store){new MutationObserver(function(mutationsList){for(var mutation in mutationsList){var event=mutationsList[mutation];if(event.type==='attributes'){if(event.target.className.indexOf('t-popup_show')!=-1){t300_init()}}}}).observe(store,{attributes:!0,attributeFilter:['class'],subtree:!0,})});t300_init()},500)}});function t675_init(recId){var rec=document.getElementById('rec'+recId);if(!rec)return;var container=rec.querySelector('.t675');if(!container)return;var textWrapper=rec.querySelectorAll('.t675__textwrapper');if(typeof jQuery!=='undefined'){$(container).bind('displayChanged',function(){t_onFuncLoad('t_slds_updateSlider',function(){t675__calcHeight(rec,textWrapper)})})}else{container.addEventListener('displayChanged',function(){t_onFuncLoad('t_slds_updateSlider',function(){t675__calcHeight(rec,textWrapper)})})}
